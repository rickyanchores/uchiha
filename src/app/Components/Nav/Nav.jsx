...
const Nav = () => {
  ...
  return (
    <div className='Nav shadow text-gray-700 font-semibold rounded-lg flex justify-between items-center p-4 mb-2  sticky top-2'>
        <Link href="/#Hero"><h1 className='font-bold text-2xl text-red-700'>uchiha</h1></Link>
